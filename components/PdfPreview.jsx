...
export function PdfPreview() {
  return (
    <section className="bg-qissali-section">
      <div className="mx-auto max-w-[1100px] px-8 py-[90px]">
        <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-2">
          <div className="relative mx-auto h-[280px] w-[200px] sm:h-[320px] sm:w-[230px] lg:h-[360px] lg:w-[260px]">
            ...
            <div
              className="absolute h-full w-full overflow-hidden rounded-[12px] border border-qissali-rose-light bg-gradient-to-br from-[var(--rose-pale)] via-white to-[var(--bg-section)] text-qissali-title shadow-[0_8px_32px_rgba(196,154,216,0.2)]"
              style={{ transform: "rotate(0deg)", zIndex: 3 }}
            >
              <div className="flex h-full flex-col p-5">
                <p className="text-xs font-semibold tracking-[0.18em] text-qissali-mauve-mid">QISSALI</p>
                <div className="mt-5 flex flex-1 flex-col items-center justify-center text-center">
                  <span className="text-5xl" aria-hidden>
                    👑
                  </span>
                  <p className="mt-3 text-sm font-medium text-qissali-title">L&apos;histoire de Nour</p>
                  <p className="mt-2 text-sm italic text-qissali-body">et les lettres qui dansaient</p>
                </div>
                <div className="mt-auto flex flex-wrap justify-center gap-2">
                  <span className="rounded-full border border-qissali-rose-light bg-white/90 px-3 py-1 text-[11px] text-qissali-body">
                    Aïd el-Fitr
                  </span>
                  <span className="rounded-full border border-qissali-rose-light bg-white/90 px-3 py-1 text-[11px] text-qissali-body">
                    Courage
          ...
          <div>
            <p className="text-[13px] font-medium uppercase tracking-[4px] text-qissali-mauve-mid">
              ✦ Ce que tu reçois par email
            </p>
            <ul className="mt-6 space-y-3 text-[16px] leading-relaxed text-qissali-body">
            ...
            <CommanderModalTrigger className="btn-primary mt-8 text-sm">
